...
uv run mssql-scripter -S %server% -d %dataBase% -U %dbUserId% -P %dbPassword% --exclude-use-database --target-server-version 2008 --schema-and-data --exclude-headers --include-objects dbo. > ./script.sql
